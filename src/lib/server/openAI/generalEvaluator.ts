...
export async function generalEvaluator(newTasks: Tasks, testCases) {
	const generalEvaluatorSysPrompt = [
		...
		`Step 3. Rate the Case: Assign a rating from 1 to 5 based on how well the test case surfaces the issue and provokes thoughtful reflection—on its own, without additional explanation. Use the following rating scale:`,
		`5 - Deeply Provocative`,
