				...
				{:else}
					{#if page.url.pathname.includes('/cases')}
						...
						{#if response === undefined}
							<Alert.Root>
								<Alert.Description>
									No bot response has been generated based on the latest edit.
								</Alert.Description>
							</Alert.Root>
						{:else}
					...
					{#if page.url.pathname.includes('/proposals/')}
						...
						{:else}
							...
							{#if response === undefined}
								<Alert.Root>
									<Alert.Description>
										No bot response has been generated based on the origianl tasks.
									</Alert.Description>
								</Alert.Root>
							{:else}
				...
				<div class="text-muted-foreground min-h-0 text-sm">
					<Accordion.Root type="single">
						<Accordion.Item value="item-1">
							<Accordion.Trigger class="text-foreground hover:cursor-pointer"
								>Compare Responses</Accordion.Trigger
							>
							<Accordion.Content>
								<div class="mb-6">
									<h4 class="mb-2">Bot response generated based on the latest edit:</h4>
									{#if edits.length === 0}
								...
								<div>
									<h4 class="mb-2">Bot response generated based on the original tasks:</h4>
